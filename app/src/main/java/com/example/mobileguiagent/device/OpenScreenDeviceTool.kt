...
object OpenScreenDeviceTool : DeviceTool {
    ...
    private val screens: Map<String, Pair<String, String>> = linkedMapOf(
        ...
        "wifi" to (Settings.ACTION_WIFI_SETTINGS to "와이파이, Wi-Fi 목록과 연결"),
        ...
        "storage" to (Settings.ACTION_INTERNAL_STORAGE_SETTINGS to "저장공간, 용량"),
        "apps" to (Settings.ACTION_APPLICATION_SETTINGS to "앱, 어플, 애플리케이션 목록과 앱별 설정"),
